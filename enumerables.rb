...
def print_spiciest_foods(spicy_foods)
  # applies the spiciest_foods method. Return a filtered array with items with heat rating over 5
  spiciest_food_over_five = spiciest_foods(spicy_foods)
  # applies the print_spicy_foods method to the filtered array
  print_spicy_foods(spiciest_food_over_five)
end
